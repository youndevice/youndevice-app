...
<html>
    ...
    <body>
        ...
        <div id="show-appliance" class="content scaffold-show" role="main">
            ...
            <f:display bean="appliance" />
            <g:form resource="${this.appliance}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.appliance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
